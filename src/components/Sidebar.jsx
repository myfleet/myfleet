...
//         { path: '/create-day-book', name: 'Create Day Book (Income/Expense)', icon: <FaBook /> },
//         { path: '/profit-loss', name: 'Create Profit and Loss Account', icon: <FaChartLine /> },
...
//         <div className="flex">
//             {/* Sidebar */}
//             <div className={`bg-gray-800 text-white min-h-screen ${isOpen ? 'w-64' : 'w-16'} transition-all duration-300`}>  
//                 {/* Top Section */}
