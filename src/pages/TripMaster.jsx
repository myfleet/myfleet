  ...
  return (
    <div>
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <h1 className="text-3xl font-bold text-center mb-8 text-blue-600">Trip Master</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-gray-700 mb-1">Trip Date & Time*</label>
                  <input
                    type="datetime-local"
                    name="tripDateTime"
                    value={formData.tripDateTime}
                    onChange={handleChange}
                    className={`w-full p-2 border rounded ${errors.tripDateTime ? 'border-red-500' : 'border-gray-300'}`}
                  />
                  {errors.tripDateTime && <p className="text-red-500 text-sm mt-1">{errors.tripDateTime}</p>}
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full p-2 border rounded ${errors.fromLocation ? 'border-red-500' : 'border-gray-300'}`}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full p-2 border rounded ${errors.toLocation ? 'border-red-500' : 'border-gray-300'}`}
                    placeholder="City, Address, etc."
                  />
                ...
                <div>
                  <label className="block text-gray-700 mb-1">Estimated Duration</label>
                  <input
                    type="text"
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-gray-700 mb-1">Vehicle Type / Model*</label>
                  <input
                    type="text"
                    name="vehicleType"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full p-2 border rounded ${errors.driverName ? 'border-red-500' : 'border-gray-300'}`}
                  />
                  {errors.driverName && <p className="text-red-500 text-sm mt-1">{errors.driverName}</p>}
                </div>
                
                <div>
                  <label className="block text-gray-700 mb-1">Driver Contact*</label>
                  <input
                    type="tel"
                    name="driverContact"
                    value={formData.driverContact}
                    onChange={handleChange}
                    className={`w-full p-2 border rounded ${errors.driverContact ? 'border-red-500' : 'border-gray-300'}`}
                    placeholder="10-15 digits"
                  />
                  {errors.driverContact && <p className="text-red-500 text-sm mt-1">{errors.driverContact}</p>}
                </div>
                
                <div>
                  <label className="block text-gray-700 mb-1">Seating/Load Capacity</label>
                  <input
                    type="text"
                    name="capacity"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full p-2 border rounded ${errors.basePrice ? 'border-red-500' : 'border-gray-300'}`}
                ...
                <div>
                  <label className="block text-gray-700 mb-1">Distance Charges</label>
                  <input
                    type="number"
                    name="distanceCharges"
                    value={formData.distanceCharges}
                    onChange={handleChange}
                    className={`w-full p-2 border rounded ${errors.distanceCharges ? 'border-red-500' : 'border-gray-300'}`}
                    placeholder="If pricing by distance"
                    min="0"
                    step="0.01"
                  />
                  {errors.distanceCharges && <p className="text-red-500 text-sm mt-1">{errors.distanceCharges}</p>}
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full p-2 border rounded ${errors.additionalCharges ? 'border-red-500' : 'border-gray-300'}`}
                    placeholder="Tolls, parking, etc."
                    min="0"
                    step="0.01"
                  />
                  {errors.additionalCharges && <p className="text-red-500 text-sm mt-1">{errors.additionalCharges}</p>}
                </div>
                
                <div>
                  <label className="block text-gray-700 mb-1">Total Trip Price</label>
                  <input
                    type="number"
                    name="totalPrice"
                ...
                <div>
                  <label className="block text-gray-700 mb-1">Advance Payment</label>
                  <input
                    type="number"
                    name="advancePayment"
                    value={formData.advancePayment}
                    onChange={handleChange}
                    className={`w-full p-2 border rounded ${errors.advancePayment ? 'border-red-500' : 'border-gray-300'}`}
                ...
                <div>
                  <label className="block text-gray-700 mb-1">Remaining Payment</label>
                  <input
                    type="number"
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h2 className="text-xl font-semibold mb-4 flex items-center">
                <span className="mr-2">📝</span> Other Helpful Fields
              </h2>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-gray-700 mb-1">Trip Status</label>
                  <select
                    name="tripStatus"
                ...
                <div className="md:col-span-2">
                  <label className="block text-gray-700 mb-1">Trip Notes</label>
                  <textarea
                    name="tripNotes"
